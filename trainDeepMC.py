...
DeepMC.train_ia(morpion1, morpion2, nb_swap, nb_episode)        # commencer l'entrainement

print("2 file was create with name : ' ./save/episode.ckpt ' and the number of the AI player")