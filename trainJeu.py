coupPossible = ( 1,2,3 )  # remplir les coup possible : ( 1er Coup , 2eme Coup , ... , Neme Coup)
nbAllumette =  17 # le nombre d'allumette totale mettre un nombre
name = ""  # donner un nom a l'Agent : "nom_de_l_agent_sans_espace"

# pas obliger de toucher plus bas
nb_train = 5  # nombre d'entrainement avant avant d'entrainer la suivante
nb_swap = 5  # nombre de fois ou on change IA1 et IA2 entre elle
max_it = 5  # profondeur de dans les etats
gamma = 1.0  # changer au cas ou ca ne converge pas
...
def train():
    ...
    ia_name = str(name) + "_" + str(cp) + "_" + str(nbAllumette) + "_" + str(max_it) + "_" + str(nb_swap) + "_" + str(
        nb_train) + "_" + str(gamma)
